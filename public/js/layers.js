...
export function createAllCells(){
    return Promise.all([
        ...
        //createCell('[', new Vec2(0,1), new Vec2(532, 155)),
        //createCell(']', new Vec2(1,1), new Vec2(580, 155)),
        ...
        //createCell(';', new Vec2(0,2), new Vec2(509, 204)),
        //createCell('\'', new Vec2(1,2), new Vec2(557, 204)),
        ...
        // createCell(',', new Vec2(4,2), new Vec2(438, 252)),
        // createCell('.', new Vec2(5,2), new Vec2(486, 252)),
        // createCell('/', new Vec2(6,2), new Vec2(533, 252)),
